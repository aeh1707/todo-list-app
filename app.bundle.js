...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _modules_CRUD_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./modules/CRUD.js */ \"./src/modules/CRUD.js\");\n/* harmony import */ var _index_css__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./index.css */ \"./src/index.css\");\n\r\n\r\n\r\nconst populateTasks = async () => {\r\n  _modules_CRUD_js__WEBPACK_IMPORTED_MODULE_0__.tasksList.innerHTML = '';\r\n  for (let i = 0; i < _modules_CRUD_js__WEBPACK_IMPORTED_MODULE_0__.tasks.length; i += 1) {\r\n    _modules_CRUD_js__WEBPACK_IMPORTED_MODULE_0__.tasksList.innerHTML += `<li class=\"task-item task-item${_modules_CRUD_js__WEBPACK_IMPORTED_MODULE_0__.tasks[i].index}\">\r\n        <div class=\"task-info\"><input type=\"checkbox\" name=\"\"><input class=\"task task${_modules_CRUD_js__WEBPACK_IMPORTED_MODULE_0__.tasks[i].index}\" type=\"text\" placeholder=\"${_modules_CRUD_js__WEBPACK_IMPORTED_MODULE_0__.tasks[i].description}\"></div>\r\n        <div class=\"dots\">\r\n          <i class=\"fa fa-ellipsis-v remove\" aria-hidden=\"true\" id=\"i${_modules_CRUD_js__WEBPACK_IMPORTED_MODULE_0__.tasks[i].index}\"></i>\r\n        </div>\r\n      </li>`;\r\n  }\r\n\r\n  const inputs = document.querySelectorAll('.task');\r\n  const checks = document.querySelectorAll('[type=\"checkbox\"]');\r\n  const deleteButton = document.querySelectorAll('.remove');\r\n  const clearAll = document.querySelector('.clearAll');\r\n\r\n  for (let i = 0; i < _modules_CRUD_js__WEBPACK_IMPORTED_MODULE_0__.tasks.length; i += 1) {\r\n    checks[i].checked = _modules_CRUD_js__WEBPACK_IMPORTED_MODULE_0__.tasks[i].completed;\r\n    if (checks[i].checked) {\r\n      inputs[i].classList.add('strike');\r\n    } else {\r\n      inputs[i].classList.remove('strike');\r\n    }\r\n    checks[i].addEventListener('click', () => {\r\n      // updateStatus(i);\r\n      if (checks[i].checked) {\r\n        _modules_CRUD_js__WEBPACK_IMPORTED_MODULE_0__.tasks[i].completed = true;\r\n        inputs[i].classList.add('strike');\r\n      } else {\r\n        _modules_CRUD_js__WEBPACK_IMPORTED_MODULE_0__.tasks[i].completed = false;\r\n        inputs[i].classList.remove('strike');\r\n      }\r\n      localStorage.setItem('tasks', JSON.stringify(_modules_CRUD_js__WEBPACK_IMPORTED_MODULE_0__.tasks));\r\n    });\r\n\r\n    clearAll.addEventListener('click', () => {\r\n      (0,_modules_CRUD_js__WEBPACK_IMPORTED_MODULE_0__.removeAllCompleted)();\r\n      populateTasks();\r\n    });\r\n\r\n    inputs[i].addEventListener('focusin', () => {\r\n      deleteButton[i].classList.remove('fa-ellipsis-v');\r\n      deleteButton[i].classList.add('fa-trash');\r\n      deleteButton[i].addEventListener('click', (e) => {\r\n        const indexToDelete = e.target.id[1];\r\n        (0,_modules_CRUD_js__WEBPACK_IMPORTED_MODULE_0__.removeTask)(indexToDelete);\r\n        localStorage.setItem('tasks', JSON.stringify(_modules_CRUD_js__WEBPACK_IMPORTED_MODULE_0__.tasks));\r\n        populateTasks();\r\n      });\r\n    });\r\n\r\n    inputs[i].addEventListener('input', (e) => {\r\n      e.target.setAttribute('placeholder', e.target.value);\r\n      _modules_CRUD_js__WEBPACK_IMPORTED_MODULE_0__.tasks[i].description = e.target.value;\r\n      localStorage.setItem('tasks', JSON.stringify(_modules_CRUD_js__WEBPACK_IMPORTED_MODULE_0__.tasks));\r\n    });\r\n\r\n    inputs[i].addEventListener('focusout', (e) => {\r\n      e.target.value = '';\r\n      deleteButton[i].classList.add('fa-ellipsis-v');\r\n      deleteButton[i].classList.remove('fa-trash');\r\n    });\r\n  }\r\n};\r\n\r\n_modules_CRUD_js__WEBPACK_IMPORTED_MODULE_0__.addTaskField.addEventListener('keypress', (e) => {\r\n  if (e.key === 'Enter') {\r\n    e.preventDefault();\r\n    (0,_modules_CRUD_js__WEBPACK_IMPORTED_MODULE_0__.addTask)(_modules_CRUD_js__WEBPACK_IMPORTED_MODULE_0__.addTaskField.value);\r\n    _modules_CRUD_js__WEBPACK_IMPORTED_MODULE_0__.addTaskField.value = '';\r\n    localStorage.setItem('tasks', JSON.stringify(_modules_CRUD_js__WEBPACK_IMPORTED_MODULE_0__.tasks));\r\n    populateTasks();\r\n  }\r\n});\r\n\r\npopulateTasks();\r\n\n\n//# sourceURL=webpack://webpack-template/./src/index.js?");
